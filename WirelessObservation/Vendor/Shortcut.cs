...
namespace WirelessObservation.Vendor
{
    class Shortcut
    {
        ...
        //    {
        //        workingDirectory = GetDeskDir();
        //    }
        //    return CreateShortcut(GetDeskDir() + "\\" + description + ".lnk", targetPath, workingDirectory, description, iconLocation);
        //}
        ...
        //    if (string.IsNullOrEmpty(workingDirectory))
        //    {
        //        workingDirectory = GetProgramsDir();
        //    }
        //    string shortcutPath = GetProgramsDir();
        ...
        //    return CreateShortcut(shortcutPath, targetPath, workingDirectory, description, iconLocation);
        //}
        ...
        //        workingDirectory = GetProgramsDir();
        //    }
        //    string shortcutPath = GetFavoriteDir();
        ...
        //    }
        //    shortcutPath += "\\" + description + ".lnk";
        //    return CreateShortcut(shortcutPath, url, workingDirectory, description, iconLocation);
        //}
        #endregion

        public static bool CreateShortcut(string Path, string Target, string Description,string Icon = "", string WorkingDirectory = "", string Hotkey = "", string Arguments = "",int WshWindowStyle = 1)
        {
            try
            {
                ...
                if (WorkingDirectory == "")
                {
                    shortcut.WorkingDirectory = Target;//程序所在文件夹，在快捷方式图标点击右键可以看到此属性
                }
